...
describe("components/password-confirmation-field", function () {
  ...
  beforeEach(function () {
    ...
    aform = form(constrains);
    attrs = {
      "model": aform.confirmPassword,
      "passwordModel": aform.password,
  ...
  it("updates value on attrs.update", function () {
    ...
    m.mount(root, m.component(passwordConfirmationField , attrs));
  ...
  it("validates on attrs.validate", function () {
    ...
    aform.confirmPassword("bpassword");
