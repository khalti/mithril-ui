...
export const column = component({
  base: base,
	attrSchema: {
		...
		size: {inclusion: {within: enums.properKeys(enums.sizeClassMap),
												message: "^Invalid value '%{value}'."}},
		...
		visible: {inclusion: {within: _.keys(enums.visibleClassMap),
													message: "^Invalid value '%{value}'."}},
		mobile: {inclusion: {within: enums.properKeys(enums.sizeClassMap),
													message: "^Invalid value '%{value}'."}},
		tablet: {inclusion: {within: enums.properKeys(enums.sizeClassMap),
													message: "^Invalid value '%{value}'."}},
		computer: {inclusion: {within: enums.properKeys(enums.sizeClassMap),
														message: "^Invalid value '%{value}'."}},
		largeScreen: {inclusion: {within: enums.properKeys(enums.sizeClassMap),
															message: "^Invalid value '%{value}'."}},
		widescreen: {inclusion: {within: enums.properKeys(enums.sizeClassMap),
															message: "^Invalid value '%{value}'."}}
	},
